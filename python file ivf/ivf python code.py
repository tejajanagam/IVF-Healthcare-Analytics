...
mean_df = df[num_cols].mean().to_frame(name='Mean')
mean_df

median_df = df[num_cols].median().to_frame(name='Median')
median_df

std_df = df[num_cols].std().to_frame(name='Std_Deviation')
std_df

skew_df = df[num_cols].skew().to_frame(name='Skewness')
skew_df


kurt_df = df[num_cols].kurtosis().to_frame(name='Kurtosis')
kurt_df
